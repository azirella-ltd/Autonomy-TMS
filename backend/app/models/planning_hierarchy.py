...
class PlanningHierarchyConfig(Base):
    ...
    __table_args__ = (
        UniqueConstraint('group_id', 'planning_type', 'config_id', name='uq_planning_hierarchy_type'),
        Index('idx_planning_hierarchy_group', 'group_id', 'is_active'),
    )
...
class SiteHierarchyNode(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_site_hierarchy_level', 'hierarchy_level', 'group_id'),
    )
...
class ProductHierarchyNode(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_product_hierarchy_level', 'hierarchy_level', 'group_id'),
    )
...
class TimeBucketConfig(Base):
    ...
    __table_args__ = (
        UniqueConstraint('group_id', 'bucket_type', name='uq_time_bucket_type'),
    )
