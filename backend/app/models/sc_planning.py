...
Updated 2026-01-11: Added tenant_id foreign keys for multi-tenancy support.
"""
...
class ProductionCapacity(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_capacity_tenant_config', 'tenant_id', 'config_id'),
...
class OrderAggregationPolicy(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_agg_policy_tenant_config', 'tenant_id', 'config_id'),
...
class SourcingSchedule(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_sourcing_schedule_tenant_config', 'tenant_id', 'config_id'),
...
class SourcingScheduleDetails(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_sourcing_schedule_details_tenant_config', 'tenant_id', 'config_id'),
