...
SAP_TABLE_REGISTRY: Dict[str, Dict] = {
    ...
    "T005":  {"category": "master", "keys": ["LAND1"], "description": "Countries"},
    "T005T": {"category": "master", "keys": ["SPRAS", "LAND1"], "description": "Country Text (English)"},
    "T005S": {"category": "master", "keys": ["LAND1", "BLAND"], "description": "Region Codes"},
    "T005U": {"category": "master", "keys": ["SPRAS", "LAND1", "BLAND"], "description": "Region Text (English)"},
