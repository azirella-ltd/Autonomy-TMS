...
D365_ENTITY_REGISTRY: Dict[str, Dict] = {
    ...
    "ProductCategoryHierarchies":   {"category": "master", "keys": ["HierarchyId"], "description": "Product Category Hierarchy Definitions (Procurement, Sales, etc.)"},
    "ProductCategories":            {"category": "master", "keys": ["CategoryId"], "description": "Product Hierarchy Category Nodes (tree via ParentCategoryId)"},
