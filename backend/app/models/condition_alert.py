...
class ConditionAlert(Base):
    ...
    __table_args__ = (
        Index("ix_condition_alert_group_type", "group_id", "condition_type"),
        Index("ix_condition_alert_entity", "entity_type", "entity_id"),
        Index("ix_condition_alert_active_severity", "is_active", "severity"),
        Index("ix_condition_alert_group_active", "group_id", "is_active"),
    )
...
class ScenarioEvaluation(Base):
    ...
    __table_args__ = (
        Index("ix_scenario_eval_group", "group_id"),
...
class SupplyRequest(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_supply_request_group_status", "group_id", "status"),
    )
