...
class RLTrainingRequest(BaseModel):
    ...
    max_periods: int = Field(52, description="Max periods per episode", ge=10, le=200)
...
def run_training_task(request: RLTrainingRequest):
    ...
    try:
        ...
        cmd = [
            ...
            "--max-periods", str(request.max_periods),
...
async def test_model(request: RLTestRequest):
    ...
    try:
        ...
        obs = np.array([
            ...
            request.last_order,
            request.period_number / 52.0,  # Normalize
