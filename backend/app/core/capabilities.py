...
POWELL_ROLE_DESCRIPTIONS = {
    "EXECUTIVE": {
        "name": "Executive (CEO / VP Supply Chain)",
        "level": "Strategic",
        "description": "Reviews business outcomes, monitors network-wide performance, issues strategic directives via Azirella",
        "scope": "Full network (all sites, all products)",
    },
    "SC_VP": {
        "name": "VP of Supply Chain",
        "level": "Strategic",
        "description": "Sets supply chain policy, reviews network performance, approves strategic recommendations",
        "scope": "Full network (all sites, all products)",
    },
    "SOP_DIRECTOR": {
        "name": "S&OP Director",
        "level": "Tactical",
        "description": "Manages S&OP planning cycle, reviews cross-site allocation decisions, balances demand and supply",
    ...
    "ORDER_PROMISE_MANAGER": {
        ...
        "level": "Execution",
        "description": "Reviews and overrides order promising and available-to-promise decisions for customer orders",
        "scope": "Customer order fulfillment (assigned sites)",
    },
    "MPS_MANAGER": {
        "name": "MPS / Execution Manager",
        "level": "Operational",
        "description": "Manages day-to-day planning execution, reviews production and replenishment decisions",
        "scope": "Site scope (specific regions/DCs)",
    },
    "ATP_ANALYST": {
        "name": "ATP Analyst",
        "level": "Execution",
        "description": "Reviews and overrides order fulfillment decisions; override reasoning improves future decision quality",
    ...
    "REBALANCING_ANALYST": {
        ...
        "level": "Execution",
        "description": "Reviews and overrides inventory transfer decisions between sites; override reasoning improves future transfers",
    ...
    "PO_ANALYST": {
        "name": "PO Analyst",
        "level": "Execution",
        "description": "Reviews and overrides purchase order timing and quantity decisions; override reasoning improves future procurement",
    ...
    "ORDER_TRACKING_ANALYST": {
        ...
        "level": "Execution",
        "description": "Reviews and overrides order exception handling decisions; override reasoning improves future exception resolution",
    ...
    "DEMO_ALL": {
        ...
        "level": "All Levels",
        "description": "Full access to all decision levels for demonstration purposes",
        "scope": "All sites, all products, all decision types",
    },
}
