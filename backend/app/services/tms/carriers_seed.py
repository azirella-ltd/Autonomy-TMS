...
BROKERS = [
    CarrierSpec("CHRW", "C.H. Robinson", "CHRW", "BROKER", "MN",
                ("FTL", "LTL", "INTERMODAL"), ("DRY_VAN", "REEFER"),
...
# ------------------------------------------------------------------
IMC_CARRIERS = [
    CarrierSpec("JBHT", "J.B. Hunt Intermodal", "JBHT", "IMC", "AR",
...
REGIONAL_SPECIALISTS = [
    CarrierSpec("TRMC", "Transco Lines (reefer)", "TRMC", "REGIONAL", "AR",
                ("FTL",), ("REEFER",), is_reefer_specialist=True,
    ...
    CarrierSpec("CAAA", "Cheeseman Transport", "CAAA", "REGIONAL", "IN",
                ("FTL",), ("REEFER",), is_reefer_specialist=True,
                approx_fleet_size=250, otd_performance=0.92, avg_linehaul_rate_cpm=2.52,
                is_national=False),
    CarrierSpec("DCTR", "Decker Truck Line", "DCTR", "REGIONAL", "IA",
                ("FTL",), ("REEFER", "DRY_VAN"),
    ...
    CarrierSpec("MCER", "McElroy Truck Lines", "MCER", "REGIONAL", "AL",
                ("FTL",), ("REEFER",), is_reefer_specialist=True,
                approx_fleet_size=450, otd_performance=0.92, avg_linehaul_rate_cpm=2.50,
                is_national=False, service_regions=("US_SOUTHEAST",)),
    CarrierSpec("WRDT", "Western Distributing Transportation", "WRDT", "REGIONAL", "CO",
                ("FTL",), ("REEFER", "DRY_VAN"),
    ...
    CarrierSpec("TRSM", "TransAm Trucking", "TRSM", "REGIONAL", "KS",
                ("FTL",), ("REEFER",), is_reefer_specialist=True,
