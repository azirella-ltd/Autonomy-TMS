...
class POCreationTRM:
    ...
    def evaluate_po_need(
        ...
        # Note: "Adjust before create" constraint is enforced by the governance
        # gate (DecisionGovernanceService.gate_decision) — not inline here.
        # The TRM generates the best recommendation; governance checks whether
        # an existing planned order can be adjusted instead.
