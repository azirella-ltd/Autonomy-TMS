...
class AgentOrchestratorService:
    ...
    async def run_planning_cycle(
        ...
        """
        logger.info(f"Starting {cycle_type} planning cycle for group {group_id}")
    ...
    async def run_complete_workflow(
        ...
        logger.info(f"Starting complete workflow for group {group_id}, tier {tier.value}")
        ...
        actions = await self.on_cdc_result(cdc_result, group_id)
        ...
        all_conditions = await condition_service.check_conditions(group_id)
