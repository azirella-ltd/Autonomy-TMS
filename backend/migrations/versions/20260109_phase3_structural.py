...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('on_hand_qty', sa.Numeric(10, 2), server_default=sa.text("FALSE"), comment='Current inventory on hand'),
        sa.Column('available_qty', sa.Numeric(10, 2), server_default=sa.text("FALSE"), comment='Available for sale/use'),
        sa.Column('reserved_qty', sa.Numeric(10, 2), server_default=sa.text("FALSE"), comment='Reserved for orders'),
        sa.Column('in_transit_qty', sa.Numeric(10, 2), server_default=sa.text("FALSE"), comment='In transit to this site'),
        sa.Column('backorder_qty', sa.Numeric(10, 2), server_default=sa.text("FALSE"), comment='Backorder quantity'),
    ...
    op.create_table(
        ...
        sa.Column('shipped_qty', sa.Numeric(10, 2), server_default=sa.text("FALSE"), comment='Shipped quantity'),
        sa.Column('received_qty', sa.Numeric(10, 2), server_default=sa.text("FALSE"), comment='Received quantity'),
