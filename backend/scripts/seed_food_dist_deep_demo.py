...
def seed_agent_decisions(db: Session, tenant_id: int, users: dict):
    ...
    decisions = [
        ...
        AgentDecision(
            ...
            status=DecisionStatus.ACTIONED, urgency=DecisionUrgency.URGENT,
        ...
        AgentDecision(
            ...
            status=DecisionStatus.ACTIONED, urgency=DecisionUrgency.STANDARD,
        ...
        AgentDecision(
            ...
            status=DecisionStatus.OVERRIDDEN, urgency=DecisionUrgency.STANDARD,
        ...
        AgentDecision(
            ...
            status=DecisionStatus.INFORMED, urgency=DecisionUrgency.LOW,
            agent_type="trm", planning_cycle="2026-W09",
        ...
        AgentDecision(
            ...
            status=DecisionStatus.OVERRIDDEN, urgency=DecisionUrgency.URGENT,
        ...
        AgentDecision(
            ...
            status=DecisionStatus.ACTIONED, urgency=DecisionUrgency.LOW,
            agent_type="trm", planning_cycle="2026-W09",
