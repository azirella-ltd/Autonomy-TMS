...
This creates a learning group with a realistic foodservice distribution
...
Or with custom parameters:
    python scripts/generate_food_dist_config.py --group-name "Food Dist Demo" --admin-email "admin@example.com"
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--group-name",
        default="Food Dist",
        help="Name of the learning group (default: Food Dist)"
    )
    parser.add_argument(
        "--admin-email",
        default="admin@distdemo.com",
        help="Email for the group admin (default: admin@distdemo.com)"
    )
    parser.add_argument(
        "--admin-name",
        default="Food Dist Admin",
        help="Name for the group admin (default: Food Dist Admin)"
    )
    parser.add_argument(
        "-v", "--verbose",
        action="store_true",
