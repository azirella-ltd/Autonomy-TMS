...
# Database
MARIADB_HOST=db
MARIADB_DATABASE=autonomy
MARIADB_USER=autonomy_user
...
# Application
CORS_ORIGINS=https://autonomy.ai
...
```bash
# 1. Backup database
docker compose exec db mysqldump -u root -p autonomy > backup.sql
...
mysql -u root -p autonomy < backups/backup_XXX/database.sql
...
# Test connection
mysql -h localhost -P 3306 -u autonomy_user -p
