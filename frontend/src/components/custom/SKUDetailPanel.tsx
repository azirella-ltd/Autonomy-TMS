...
const defaultSkuData = {
  ...
  businessMetrics: { revenueTarget: { display: "" }, agentPerformanceScore: { display: "" }, actualRevenueForecast: { display: "", calculation: "" }, flaggedRevenue: "", flaggedUnits: "" },
      ...
      <div className="overflow-y-auto border border-border rounded-sm m-3">
        ...
        <div className="bg-muted">
          ...
          <div className="space-y-2 text-sm bg-card p-4">
            ...
            <div>
              <span className="text-muted-foreground text-xs">Agent Performance Score</span>
              <div className="flex items-center gap-2">
                <span className="text-lg font-semibold text-primary">{skuData.businessMetrics.agentPerformanceScore.display}</span>
              </div>
            </div>
            <div>
