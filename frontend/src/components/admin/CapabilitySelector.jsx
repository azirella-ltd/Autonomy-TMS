...
const CAPABILITY_TREE = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      { id: 'view_trm_training', label: 'View Agent Training', description: 'View AI agent training status' },
      { id: 'manage_trm_training', label: 'Manage Agent Training', description: 'Train and manage AI agents' },
      { id: 'view_gnn_training', label: 'View Network Agent Training', description: 'View network model training status' },
      { id: 'manage_gnn_training', label: 'Manage Network Agent Training', description: 'Train and manage network models' },
