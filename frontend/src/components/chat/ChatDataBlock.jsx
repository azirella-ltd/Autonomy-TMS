/**
 * ChatDataBlock — Renders structured data blocks inline in the Azirella chat.
 *
 * Lives under `components/chat/` (not `decision-stream/`) because it's a
 * chat message renderer, not a Decision Stream component. The Decision
 * Stream itself is now provided by `@azirella-ltd/autonomy-frontend`.
 *
 * Supports block_type:
