  ...
  // ============================================================================
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'SDAM framework - narrow TRM execution services',
      },
      {
        ...
        icon: CrosshairIcon,
        requiredCapability: 'view_atp_ctp',
        description: 'Priority-based allocation management',
      },
      {
        ...
        icon: RiskIcon,
        requiredCapability: 'view_powell',
        description: 'Order tracking and exception alerts',
      },
      {
        label: 'Rebalancing TRM',
        path: '/admin/powell',
        icon: TurnaroundIcon,
        requiredCapability: 'view_powell',
        description: 'Cross-site inventory optimization',
      },
      // --- MODEL TRAINING ---
      {
...
export const SYSTEM_ADMIN_NAVIGATION = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: '/admin/powell',
        icon: LayersIcon,
        description: 'SDAM narrow TRM execution services',
      },
      {
        label: 'TRM Training',
        path: '/admin/trm',
