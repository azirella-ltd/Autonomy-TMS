  ...
  const capabilityCategories = {
    ...
    ai_ml: {
      ...
      capabilities: [
        ...
        { id: 'view_trm_training', label: 'View Agent Training', description: 'View AI agent training dashboard' },
        { id: 'start_trm_training', label: 'Start Agent Training', description: 'Start AI agent training' },
        { id: 'manage_trm_models', label: 'Manage AI Agents', description: 'Manage AI agent models' },
        { id: 'view_gnn_training', label: 'View Network Agent Training', description: 'View network model training dashboard' },
        { id: 'start_gnn_training', label: 'Start Network Agent Training', description: 'Start network model training' },
        { id: 'manage_gnn_models', label: 'Manage Network Agents', description: 'Manage network models' },
