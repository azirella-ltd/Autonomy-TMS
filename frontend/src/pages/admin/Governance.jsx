...
const Governance = () => {
  ...
  const loadMockData = () => {
    setAuditLogs([
      ...
      { id: 3, timestamp: new Date(Date.now() - 7200000).toISOString(), user: 'player@company.com', action: 'VIEW_GAME', resource: 'Game ID: 42', status: 'SUCCESS', ip: '172.29.56.150' },
      { id: 4, timestamp: new Date(Date.now() - 10800000).toISOString(), user: 'systemadmin@autonomy.ai', action: 'UPDATE_CONFIG', resource: 'Supply Chain Config: Default Beer Game', status: 'SUCCESS', ip: '172.29.56.211' },
      { id: 5, timestamp: new Date(Date.now() - 14400000).toISOString(), user: 'player@company.com', action: 'LOGIN', resource: 'System', status: 'FAILED', ip: '172.29.56.155' },
    ]);
