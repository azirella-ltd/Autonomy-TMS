...
const CreateMixedGame = () => {
  ...
  const buildGameSnapshot = useCallback((statePayload) => {
    ...
    const mappedScenarioUsers = rawScenarioUsers.reduce((acc, record) => {
      ...
      acc[roleValue] = {
        role: roleValue,
        scenarioUserType: isAi ? 'ai' : 'human',
  ...
  const handleStrategyChange = (index, strategy) => {
    setScenarioUsers((prevScenarioUsers) =>
      prevScenarioUsers.map((scenarioUser, i) => {
        ...
        const updated = { ...scenarioUser, strategy };
        ...
        <form onSubmit={handleFormSubmit} className="space-y-6 max-w-6xl mx-auto w-full">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-3">
              ...
              <TabsTrigger value="scenarioUsers">Users</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="scenarioUsers" className="mt-6">
              <Card>
                <CardHeader>
