...
DEFAULT_BASE_URL = os.getenv("AUTONOMY_API_BASE_URL", "http://localhost:8000")
LOG = logging.getLogger(__name__)


class SimulationClient:
    """Simple REST client for the Autonomy backend."""
...
TOOLS = [
    {
        ...
        "function": {
            "name": "run_simulation",
            "description": "Run a supply chain simulation and return the state history.",
...
INSTRUCTIONS = (
    "You are the Supply Chain Strategist. Use the provided tools to simulate supply chain "
...
if __name__ == "__main__":
    ...
    base = os.getenv("AUTONOMY_API_BASE_URL", DEFAULT_BASE_URL)
