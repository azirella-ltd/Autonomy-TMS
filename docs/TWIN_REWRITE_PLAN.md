...
| ↳ **PR-3.F** | Exception Generator — same `PhysicsModel` protocol, same feature-flag pattern. Open in [#32](https://github.com/azirella-ltd/Autonomy-TMS/pull/32). | Unblocks ExceptionManagement TRM. |
