...
| ↳ **PR-3.C–E** | Dock Queue, Equipment Flow, Spot-Rate Market — same `PhysicsModel` protocol, same feature-flag pattern. Open in [#27](https://github.com/azirella-ltd/Autonomy-TMS/pull/27), [#28](https://github.com/azirella-ltd/Autonomy-TMS/pull/28), [#29](https://github.com/azirella-ltd/Autonomy-TMS/pull/29). | Each unblocks the TRMs listed at its design-doc anchor. |
