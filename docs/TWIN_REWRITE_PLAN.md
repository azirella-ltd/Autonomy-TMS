...
| ↳ **PR-3.E–F** | Spot-Rate Market, Exception Generator — same `PhysicsModel` protocol, same feature-flag pattern. Open in [#29](https://github.com/azirella-ltd/Autonomy-TMS/pull/29), [#32](https://github.com/azirella-ltd/Autonomy-TMS/pull/32). | Each unblocks the TRMs listed at its design-doc anchor. |
