...
| ↳ **PR-3.D–F** | Equipment Flow, Spot-Rate Market, Exception Generator — same `PhysicsModel` protocol, same feature-flag pattern. Open in [#28](https://github.com/azirella-ltd/Autonomy-TMS/pull/28), [#29](https://github.com/azirella-ltd/Autonomy-TMS/pull/29), [#32](https://github.com/azirella-ltd/Autonomy-TMS/pull/32). | Each unblocks the TRMs listed at its design-doc anchor. |
